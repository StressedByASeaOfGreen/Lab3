...
class OORMSTestCase(unittest.TestCase):
    ...
    def test_order_controller_add_item(self):
        ...
        self.assertEqual(the_order.items[0].menu_item, the_menu_item)
    ...
    def test_order_controller_update_several_then_cancel(self):
        ...
        def check_first_three_items(menu_items, items):
            self.assertEqual(menu_items[0], items[0].menu_item)
            self.assertEqual(menu_items[3], items[1].menu_item)
            self.assertEqual(menu_items[5], items[2].menu_item)
        ...
        check_first_three_items(self.restaurant.menu_items, the_order.items)
        self.assertEqual(self.restaurant.menu_items[1], the_order.items[3].menu_item)
        self.assertEqual(self.restaurant.menu_items[2], the_order.items[4].menu_item)